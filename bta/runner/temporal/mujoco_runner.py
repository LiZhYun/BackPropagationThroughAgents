...
class MujocoRunner(Runner):
    ...
    def collect(self, step):
        ...
        if self.use_action_attention:
            ...
            bias_, action_std, rnn_states_joint = self.action_attention(logits.reshape(-1, self.action_dim), share_obs, rnn_states_joint, masks, hard_actions)
