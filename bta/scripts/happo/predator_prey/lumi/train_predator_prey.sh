#!/bin/bash
#SBATCH --job-name=predatorprey-happo
#SBATCH --output=./out/predatorprey-happo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/predatorprey-happo_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
