#!/bin/bash
#SBATCH --job-name=smac-mappo
#SBATCH --output=./out/smac-mappo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/smac-mappo_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
--map_name ${map} --seed $SLURM_ARRAY_TASK_ID --units ${units} --n_training_threads 1 --n_rollout_threads 50 --num_mini_batch 1 --episode_length 400 \
