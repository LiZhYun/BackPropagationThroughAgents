...
#SBATCH --job-name=football-5v5-mappo
#SBATCH --output=./out/football-5v5-mappo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-5v5-mappo_err_%A_%a.txt  # Name of stderr error file
