...
#SBATCH --job-name=football-ca-mappo
#SBATCH --output=./out/football-ca-mappo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-ca-mappo_err_%A_%a.txt  # Name of stderr error file
