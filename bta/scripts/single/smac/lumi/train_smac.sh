#!/bin/bash
#SBATCH --job-name=smac-single
#SBATCH --output=./out/smac-single_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/smac-single_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
