#!/bin/bash
#SBATCH --job-name=mujoco-single
#SBATCH --output=./out/mujoco-single_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-single_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
