#!/bin/bash
#SBATCH --job-name=overcooked-mappo
#SBATCH --output=./out/overcooked-mappo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/overcooked-mappo_err_%A_%a.txt  # Name of stderr error file
