#!/bin/bash
#SBATCH --job-name=smac-gcs
#SBATCH --output=./out/smac-gcs_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/smac-gcs_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
