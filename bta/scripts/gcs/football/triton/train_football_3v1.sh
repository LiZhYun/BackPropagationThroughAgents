...
#SBATCH --job-name=football-3v1-gcs
#SBATCH --output=./out/football-3v1-gcs_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-3v1-gcs_err_%A_%a.txt  # Name of stderr error file
