...
#SBATCH --job-name=football-11_vs_11-gcs
#SBATCH --output=./out/football-11_vs_11-gcs_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-11_vs_11-gcs_err_%A_%a.txt  # Name of stderr error file
