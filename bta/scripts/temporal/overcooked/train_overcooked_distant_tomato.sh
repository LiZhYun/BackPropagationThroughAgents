...
CUDA_VISIBLE_DEVICES=0 singularity exec --bind /scratch --nv /scratch/work/liz23/bpta.sif python ../../train/train_overcooked.py \
    ...
    --ppo_epoch 15 --clip_param 0.2 \
    --max_grad_norm 0.5 --lr 1e-4 --critic_lr 5e-4 \
