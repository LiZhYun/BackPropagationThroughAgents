#!/bin/bash
#SBATCH --job-name=overcooked-diff-orders-temporal
#SBATCH --output=./out/overcooked-diff-orders_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/overcooked-diff-orders_err_%A_%a.txt  # Name of stderr error file
