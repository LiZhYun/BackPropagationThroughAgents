#!/bin/bash
#SBATCH --job-name=overcooked-h-far-tomato-temporal
#SBATCH --output=./out/overcooked-h-far-tomato_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/overcooked-h-far-tomato_err_%A_%a.txt  # Name of stderr error file
