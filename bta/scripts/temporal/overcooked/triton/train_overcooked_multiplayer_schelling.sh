#!/bin/bash
#SBATCH --job-name=overcooked-multiplayer-schelling-temporal
#SBATCH --output=./out/overcooked-multiplayer-schelling_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/overcooked-multiplayer-schelling_err_%A_%a.txt  # Name of stderr error file
