#!/bin/bash
#SBATCH --job-name=football-ca-temporal_ar
#SBATCH --output=./out/football-ca-temporal_ar_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-ca-temporal_ar_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
