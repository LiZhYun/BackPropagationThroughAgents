...
#SBATCH --job-name=football-counterattack-temporal
#SBATCH --output=./out/football-counterattack-temporal_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-counterattack-temporal_err_%A_%a.txt  # Name of stderr error file
