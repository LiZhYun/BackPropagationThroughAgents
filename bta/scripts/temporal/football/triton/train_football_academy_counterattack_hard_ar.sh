...
#SBATCH --job-name=football-counterattack-temporal_ar
#SBATCH --output=./out/football-counterattack-temporal_ar_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-counterattack-temporal_ar_err_%A_%a.txt  # Name of stderr error file
