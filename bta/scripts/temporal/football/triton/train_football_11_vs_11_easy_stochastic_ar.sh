...
#SBATCH --job-name=football-11_vs_11-temporal_ar
#SBATCH --output=./out/football-11_vs_11-temporal_ar_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/football-11_vs_11-temporal_ar_err_%A_%a.txt  # Name of stderr error file
