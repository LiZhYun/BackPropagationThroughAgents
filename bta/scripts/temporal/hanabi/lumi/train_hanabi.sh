...
echo "env is ${env}, algo is ${algo}, exp is ${exp} threshold is ${threshold}"
...
--threshold ${threshold} --gain 0.01 --lr 5e-5 --critic_lr 1e-3 --hidden_size 512 --layer_N 2 --entropy_coef 0.015 \ 
