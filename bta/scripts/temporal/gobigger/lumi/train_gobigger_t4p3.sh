...
#SBATCH --output=./out/gobigger-t4p3-temporal_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/gobigger-t4p3-temporal_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
