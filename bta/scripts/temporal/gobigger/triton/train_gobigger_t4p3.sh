...
--max_edges 10  --time_channels 100 --time_gap 10 --time_gap 10 --lr 1e-4 --critic_lr 1e-4 --threshold ${threshold} --entropy_coef 0.025 --max_grad_norm 0.5 --value_loss_coef 0.5
