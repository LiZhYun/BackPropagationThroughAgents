...
--save_interval 200000 --log_interval 100000 --use_eval --eval_interval 400000 --n_eval_rollout_threads 5 --eval_episodes 100 \
--n_rollout_threads 50 --num_mini_batch 50 --max_grad_norm 0.5 \
