#!/bin/bash
#SBATCH --job-name=mujoco-full
#SBATCH --output=./out/mujoco-full_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-full_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
