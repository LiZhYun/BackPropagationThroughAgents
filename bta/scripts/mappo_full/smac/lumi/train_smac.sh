#!/bin/bash
#SBATCH --job-name=smac-full
#SBATCH --output=./out/smac-full_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/smac-full_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
