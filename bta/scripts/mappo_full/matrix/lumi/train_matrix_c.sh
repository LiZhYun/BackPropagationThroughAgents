#!/bin/bash
#SBATCH --job-name=matrix-mappo
#SBATCH --output=./out/matrix-mappo_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/matrix-mappo_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
