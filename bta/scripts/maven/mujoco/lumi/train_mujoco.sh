#!/bin/bash
#SBATCH --job-name=mujoco-maven
#SBATCH --output=./out/mujoco-maven_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-maven_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
