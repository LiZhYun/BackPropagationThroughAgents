#!/bin/bash
#SBATCH --job-name=smac-maven
#SBATCH --output=./out/smac-maven_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/smac-maven_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
