#!/bin/bash
#SBATCH --job-name=predatorprey-maven
#SBATCH --output=./out/predatorprey-maven_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/predatorprey-maven_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
