#!/bin/bash
#SBATCH --job-name=mujoco-macpf
#SBATCH --output=./out/mujoco-macpf_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-macpf_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
