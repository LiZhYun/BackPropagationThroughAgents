#!/bin/bash
#SBATCH --job-name=matrix-ar
#SBATCH --output=./out/matrix-ar_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/matrix-ar_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
