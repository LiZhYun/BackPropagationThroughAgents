#!/bin/bash
#SBATCH --job-name=mujoco-mat_dec
#SBATCH --output=./out/mujoco-mat_dec_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-mat_dec_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
