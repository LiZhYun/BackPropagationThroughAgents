#!/bin/bash
#SBATCH --job-name=mujoco-mat
#SBATCH --output=./out/mujoco-mat_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/mujoco-mat_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
