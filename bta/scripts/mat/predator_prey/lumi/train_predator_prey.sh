#!/bin/bash
#SBATCH --job-name=predatorprey-mat
#SBATCH --output=./out/predatorprey-mat_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/predatorprey-mat_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
