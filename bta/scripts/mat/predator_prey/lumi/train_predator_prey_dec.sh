#!/bin/bash
#SBATCH --job-name=predatorprey-mat_dec
#SBATCH --output=./out/predatorprey-mat_dec_%A_%a.out # Name of stdout output file
#SBATCH --error=./out/predatorprey-mat_dec_err_%A_%a.txt  # Name of stderr error file
#SBATCH --nodes=1
#SBATCH --ntasks=1
