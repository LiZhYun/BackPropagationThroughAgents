...
class MacpfPolicy:
    ...
    def evaluate_actions(self, obs, rnn_states, rnn_states_critic, action, masks, parents_actions, execution_mask, dep_mode, available_actions=None, deterministic=False, active_masks=None, **kwargs):
        ...
        values, _ = self.critic(obs, rnn_states_critic, action, masks, parents_actions, execution_mask, dep_mode)
        return values, action_log_probs, dist_entropy

    def act(self, obs, rnn_states, masks, parents_actions, execution_mask, dep_mode, available_actions=None, deterministic=False, **kwargs):
        actions, _, rnn_states = self.actor(obs, rnn_states, masks, parents_actions, execution_mask, dep_mode, available_actions, deterministic)
