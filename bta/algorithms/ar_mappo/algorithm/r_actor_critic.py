...
class R_Actor(nn.Module):
    def __init__(self, args, obs_space, action_space, device=torch.device("cpu")):
        ...
        input_size += (args.num_agents-1) * self.action_dim
    ...
    def forward(self, obs, rnn_states, masks, onehot_action, execution_mask, available_actions=None, deterministic=False):        
        ...
        actions, action_log_probs, dist_entropy = self.act(actor_features, available_actions, deterministic, rsample=False)
