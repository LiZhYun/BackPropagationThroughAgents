...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='zhiyuanli',help="[for wandb usage], to specify user's name for simply collecting training data.")
    parser.add_argument("--wandb_name", type=str, default='zhiyuanli',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--attn_N", type=int, default=2, help="the number of attn layers, by default 1")
    ...
    parser.add_argument("--kl_coef", type=float, default=1e-5,
                        help='KL term coefficient (default: 0.00001)')
