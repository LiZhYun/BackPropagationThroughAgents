...
class SharedReplayBuffer(object):
    ...
    def recurrent_generator(self, num_mini_batch, data_chunk_length):
        ...
        target_rnn_states_critic = self.rnn_states_critic[1:].transpose(1, 0, 2, 3, 4).reshape(-1, *self.rnn_states_critic.shape[2:])
        ...
        for indices in sampler:
            ...
            target_rnn_states_critic_batch = []
            actions_batch = []
            available_actions_batch = []
            ...
            target_rnn_states_critic_batch = np.stack(target_rnn_states_critic_batch).reshape(N, *self.rnn_states_critic.shape[2:])
