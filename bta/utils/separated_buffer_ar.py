...
class SeparatedReplayBuffer(object):
    def __init__(self, args, obs_space, share_obs_space, act_space):
        ...
        self.actions = np.zeros((self.episode_length, self.n_rollout_threads, self.args.num_agents, self.act_shape))
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        actions = self.actions.transpose(1, 0, 2, 3).reshape(-1, *self.actions.shape[2:])
