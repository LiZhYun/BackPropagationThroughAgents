import torch
import numpy as np
from bta.utils.util import get_shape_from_obs_space, get_shape_from_act_space, flatten
...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        if act_space.__class__.__name__ == "Discrete":
            ...
            self.n_actions = continous_dim + discrete_dim
        ...
        self.father_actions = np.zeros(
            (self.episode_length, self.n_rollout_threads, num_agents, num_agents*self.n_actions), dtype=np.float32)
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        for indices in sampler:
            ...
            father_action_batch = father_actions[indices]
            ...
            yield share_obs_batch, obs_batch, rnn_states_batch, rnn_states_critic_batch, actions_batch,\
                  ...
                  adv_targ, available_actions_batch, father_action_batch, last_actions_batch
